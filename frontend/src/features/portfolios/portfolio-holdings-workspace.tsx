...
export function PortfolioHoldingsWorkspace({
  ...
  const openColumns = createOpenColumns(openHoldingEditor, setDeleteHoldingTarget, holdingSort, toggleHoldingSort, canReorderOpen);
  const closedColumns = createClosedColumns(openHoldingEditor, setDeleteHoldingTarget, holdingSort, toggleHoldingSort);
...
function createOpenColumns(
  ...
  return [
    ...
    },
    {
      ...
      meta: { align: "center", sticky: "right", cellClassName: "w-[96px]" },
    },
  ];
}
  ...
  return (
    <div className="relative flex w-full items-center justify-center">
      ...
      <div className="min-w-0 text-center">
        ...
        <p className="mt-1 font-mono text-label tracking-[0.04em] text-muted-foreground/60">{holding.thscode}</p>
      </div>
    </div>
  );
}
