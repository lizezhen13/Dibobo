...
export function OverviewPage() {
  ...
  const marketTemperature = useMarketTemperatureQuery(isAShareActive);
  ...
  const queries = [indices, hotStocks, marketTemperature, marketBreadth, industries];
        ...
        <TabsContent value="a-share" className="mt-0">
          ...
          <div className="grid grid-cols-1 gap-4 xl:grid-cols-2 2xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)_minmax(340px,0.95fr)] 2xl:grid-rows-[auto_330px_350px]">
            ...
            <div className="min-w-0 2xl:col-start-2 2xl:row-start-2">
              <MarketTemperatureCard query={marketTemperature} />
            </div>
