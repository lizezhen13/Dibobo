  ...
  return (
    <FilterPanel
      ...
      trailing={
        <span
          className={cn(
            "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 font-mono text-table tracking-[0.08em] transition-colors",
            activeFilterCount > 0 ? "border-primary/25 bg-primary/10 text-primary-text" : "border-border/80 bg-background/35 text-subtle",
          )}
        >
      ...
      footer={
        (isFiltered || sortKey !== "custom") && (
          <div className="flex flex-wrap items-center justify-between gap-3 text-caption text-subtle">
    ...
    >
      <PopoverTrigger asChild>
        <button
          ...
          aria-expanded={open}
          className={cn(
            "inline-flex h-10 w-full items-center justify-between gap-2 rounded-lg border bg-background px-3.5 text-table text-foreground transition hover:border-primary/40 hover:bg-secondary focus-visible:border-primary/40 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/15",
          ...
          {options.map((option) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left text-table transition",
                  isSelected
