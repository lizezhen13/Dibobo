    ...
    >
      <PopoverTrigger asChild>
        <button
          ...
          aria-expanded={open}
          className={cn(
            "inline-flex h-10 w-full items-center justify-between gap-2 rounded-lg border bg-background px-3.5 text-[13.5px] text-foreground transition hover:border-primary/40 hover:bg-secondary focus-visible:border-primary/40 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/15",
          ...
          {options.map((option) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left text-[13.5px] transition",
                  isSelected
